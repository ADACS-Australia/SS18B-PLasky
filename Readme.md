...
* `cd django_hpc_job_controller/server/` (enter the server folder of django_hpc_job controller)
* `pip3 install -r requirements.txt` (install required python packages for the django_hpc_job_controller server)
* `cd ../../` (enter the root directory of the project)
